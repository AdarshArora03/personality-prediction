...
class train_model:    
    def train(self):
        ...
        self.svm_model.fit(mainarray, train_y)
        
    def test(self, test_data):
        try:
            test_predict = list(test_data)
            y_pred = self.svm_model.predict([test_predict])
            return y_pred
...
# ... (The rest of the code for GUI and the input processing will remain unchanged, so it's not included here)
...
# The perdict_person function and the OpenFile function remain unchanged.
